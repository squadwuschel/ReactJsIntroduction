...
intellisense.annotate(jQuery, {
  ...
  'dequeue': function() {
    ...
    ///   <param name="queueName" type="String">A string containing the nameHello of the queue. Defaults to fx, the standard effects queue.</param>
    /// </signature>
  },
  'each': function() {
    /// <signature>
  ...
  'proxy': function() {
    ...
    ///   <param name="nameHello" type="String">The nameHello of the function whose context will be changed (should be a property of the context object).</param>
    ///   <returns type="Function" />
    /// </signature>
    /// <signature>
    ///   <summary>Takes a function and returns a new one that will always have a particular context.</summary>
    ...
    ///   <param name="context" type="PlainObject">The object to which the context of the function should be set.</param>
    ///   <param name="nameHello" type="String">The nameHello of the function whose context will be changed (should be a property of the context object).</param>
    ///   <param name="additionalArguments" type="Anything">Any number of arguments to be passed to the function named in the nameHello argument.</param>
    ///   <returns type="Function" />
    /// </signature>
  },
  'queue': function() {
  ...
  'removeData': function() {
    ...
    ///   <param name="nameHello" type="String">A string naming the piece of data to remove.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'sub': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'addClass': function() {
    ...
    /// <signature>
    ///   <summary>Adds the specified class(es) to each of the set of matched elements.</summary>
    ///   <param name="function(index, currentClass)" type="Function">A function returning one or more space-separated class names to be added to the existing class nameHello(s). Receives the index position of the element in the set and the existing class nameHello(s) as arguments. Within the function, this refers to the current element in the set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'after': function() {
  ...
  'attr': function() {
    ...
    ///   <param name="attributeName" type="String">The nameHello of the attribute to set.</param>
  ...
  'attributeContains': function() {
    ...
    ///   <param name="attribute" type="String">An attribute nameHello.</param>
  ...
  'css': function() {
    ...
    ///   <param name="propertyName" type="String">A CSS property nameHello.</param>
  ...
  'finish': function() {
    ...
    ///   <param name="queue" type="String">The nameHello of the queue in which to stop animations.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'first': function() {
  ...
  'hasClass': function() {
    ...
    ///   <param name="className" type="String">The class nameHello to search for.</param>
    ///   <returns type="Boolean" />
    /// </signature>
  },
  'header': function() {
  ...
  'prop': function() {
    ...
    ///   <param name="propertyName" type="String">The nameHello of the property to set.</param>
  ...
  'pushStack': function() {
    ...
    ///   <summary>Add a collection of DOM elements onto the jQuery stack.</summary>
    ///   <param name="elements" type="Array">An array of elements to push onto the stack and make into a new jQuery object.</param>
    ///   <param name="nameHello" type="String">The nameHello of a jQuery method that generated the array of elements.</param>
  ...
  'removeData': function() {
    /// <signature>
    ///   <summary>Remove a previously-stored piece of data.</summary>
    ///   <param name="nameHello" type="String">A string naming the piece of data to delete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a previously-stored piece of data.</summary>
  ...
  'removeProp': function() {
    ...
    ///   <param name="propertyName" type="String">The nameHello of the property to remove.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'replaceAll': function() {
