                ...
                */
                 ...
                 */
                {
                  ...
                  */
                 {
                     ...
                     //ACHTUNG wir müssen den publicPath hier überschreiben, da sonst im Pfad "wwwroot/wwwroot/...woff" gesucht wird. Liegt daran das wir SubUrls verwenden.
                     use: 'url-loader?publicPath=../wwwroot/&limit=65000&mimetype=application/font-woff'
                 },
                 {
                     test: /\.ttf(\?v=\d+\.\d+\.\d+)?$/,
                     use: 'url-loader?publicPath=../wwwroot/&limit=65000&mimetype=application/octet-stream'
                 },
                 {
                     test: /\.eot(\?v=\d+\.\d+\.\d+)?$/,
                     use: 'file-loader?publicPath=../wwwroot/'
                 },
                 {
                     test: /\.svg(\?v=\d+\.\d+\.\d+)?$/,
                     loader: "svg-url-loader?publicPath=../wwwroot/&limit=65000&mimetype=image/svg+xml"
                 },
